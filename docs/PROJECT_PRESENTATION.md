...
5. (ทางเลือก) คลิก "ปรับแต่งโมเดลด้วย Hyperparameter Tuning" 🆕
   - รอการ Tuning (อาจใช้เวลา 1-2 นาที)
   - ดู R² Score ที่ดีขึ้น
...
3. เลือกโมเดลที่ต้องการใช้ 🆕
   - โมเดลปกติ (เร็วกว่า)
   - โมเดล Tuned (แม่นยำกว่า)
4. ดูผลการทำนาย
5. เปรียบเทียบกับค่าจริง (ถ้ามี)
...
- **R (Red)**: 45.2% - มีผลต่อการทำนายมากที่สุด
- **G (Green)**: 32.8% - มีผลรองลงมา
- **B (Blue)**: 22.0% - มีผลน้อยที่สุด
- **การตีความ**: สีแดงมีความสำคัญสูงสุดในการทำนายความเข้มข้นของ Phosphate
...
4. **แม่นยำ**: R² Score สูงถึง 98%+ (99%+ หลัง Tuning) 🆕
...
8. **ปรับแต่งอัตโนมัติ**: Hyperparameter Tuning เพิ่มความแม่นยำ 🆕
9. **วิเคราะห์เชิงลึก**: Feature Importance แสดงความสำคัญของแต่ละสี 🆕
10. **เลือกโมเดลได้**: สลับระหว่างโมเดลปกติและ Tuned ตามความต้องการ 🆕
